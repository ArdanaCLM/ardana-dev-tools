...
usage() {
    ...
    echo "--enable-spectrev2    -- Enable Spectre V2 mitigation when building"
    echo "                         qcow2 images; enables --build-images implicitly."
    ...
    echo "                         be included into the NEW_RPMS area. (repeatable)"
